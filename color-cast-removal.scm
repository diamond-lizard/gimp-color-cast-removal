...
(define (get-average-selection-color given-image given-layer)
  (let* ((selection-upper-left-bounds (get-upper-left-bounds given-image))
         ...
         (ignored (gimp-edit-named-copy given-layer "color-cast-removal sample"))
         (floating-selection (car (gimp-edit-named-paste given-layer "color-cast-removal sample" FALSE)))
